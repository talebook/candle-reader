...
//   surface Vuetify 面板色：同色系、比 bg 更浓一档，用于卡片/底部弹窗/顶栏/底部导航等组件底色
//           （由 plugins/vuetify.js 据此为每个皮肤生成一套主题；文字对比色交给 Vuetify 自动推导）
//   bgTop/bgBottom  顶/底安全区颜色（iOS 刘海、home indicator）。图片皮肤设成背景图上/下沿色
//           （已按 mask 叠加估算），使安全区与底图衔接；纯色皮肤不填，回退到 bg
...
export const THEMES = [
  ...
  { id: 'white',   name: '白色',   type: 'solid', mode: 'day',
    bg: '#F6F6F6', surface: '#E9E9E9', text: '#142614', icon: 'mdi-weather-sunny', sample: '白底黑字，清爽分明' },
  { id: 'eyecare', name: '护眼',   type: 'solid', mode: 'day',
    bg: '#D3E3D3', surface: '#BCD3BC', text: '#142614', icon: 'mdi-eye', sample: '绿意护眼，久读不累' },
  { id: 'grey',    name: '夜灰',   type: 'solid', mode: 'night',
    bg: '#1A1A1A', surface: '#2C2C2C', text: '#C3C3C3', icon: 'mdi-weather-night', sample: '暗夜阅读，柔和不刺眼' },
  { id: 'dark',    name: '纯黑',   type: 'solid', mode: 'night',
    bg: '#000000', surface: '#171717', text: '#4B4B4B', icon: 'mdi-candle', sample: '极致省电，深邃沉静' },
